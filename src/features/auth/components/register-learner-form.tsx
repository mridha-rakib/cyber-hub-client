...
import { useRegisterLearner } from "@/hooks/use-auth-mutations";
import { useZodForm } from "@/hooks/use-zod-form";
import { isApiError } from "@/lib/errors/api-error";
import { registerLearnerSchema } from "@/schemas/auth.schema";

export function RegisterLearnerForm() {
  const [submitted, setSubmitted] = useState(false);
  const register = useRegisterLearner();
  const form = useZodForm(registerLearnerSchema, {
